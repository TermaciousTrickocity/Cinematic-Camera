...
{
    /*
          Found this on some random fourm ages ago 
            Shout out to whoever wrote this
    */

    public static class XRPCExtensions
    {
        private static byte[] buffer = new byte[0x20];
        ...
        {
            xpc.xbCon.DebugTarget.GetMemory(Offset, 1, buffer, out outInt);
        ...
        {
            xpc.xbCon.DebugTarget.GetMemory(Offset, 2, buffer, out outInt);
        ...
        {
            xpc.xbCon.DebugTarget.GetMemory(Offset, 4, buffer, out outInt);
        ...
        {
            xpc.xbCon.DebugTarget.GetMemory(Offset, 8, buffer, out outInt);
        ...
        {   
            return ReadString(xpc, Offset, buffer);
        }

        public static void WriteSByte(this XRPC xpc, uint Offset, sbyte input)
        {
            buffer[0] = (byte)input;
            xpc.xbCon.DebugTarget.SetMemory(Offset, 1, buffer, out outInt);
        }
        ...
        public static void WriteInt16(this XRPC xpc, uint Offset, short input)
        {
            ...
            Array.Reverse(buffer, 0, 2);
            xpc.xbCon.DebugTarget.SetMemory(Offset, 2, buffer, out outInt);
        }
        ...
        public static void WriteInt32(this XRPC xpc, uint Offset, int input)
        {
            BitConverter.GetBytes(input).CopyTo(buffer, 0);
            Array.Reverse(buffer, 0, 4);
            xpc.xbCon.DebugTarget.SetMemory(Offset, 4, buffer, out outInt);
        }
        ...
        public static void WriteInt64(this XRPC xpc, uint Offset, long input)
        {
            BitConverter.GetBytes(input).CopyTo(buffer, 0);
            Array.Reverse(buffer, 0, 8);
            xpc.xbCon.DebugTarget.SetMemory(Offset, 8, buffer, out outInt);
        }
